...
export const FAQS = [
  ...
  },
  {
    ...
    a: 'Simply tap any "Shop" button or the floating WhatsApp icon to chat with us directly. We will guide you through sizing, lengths, and styles.',
  },
  {
    q: 'Do you offer customisation?',
    a: 'Yes. Text a hairstylist via WhatsApp and we will advise based on your face shape, style preference, and budget - no guesswork.',
  },
  {
